...
export default function ButtonJobAdd() {
    ...
    return (
        <>
        <button onClick={() => handlerOpenModalAddJob()} className="bg-primary text-white px-5 py-2.5 rounded-xl font-semibold hover:bg-primary-hover transition-colors flex items-center gap-2 cursor-pointer w-full sm:w-auto justify-center shadow-sm shadow-primary/30">
