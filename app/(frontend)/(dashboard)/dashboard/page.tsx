        ...
        <section id="section-overview" className="space-y-6 block">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="flex items-end gap-2">
                    <h3 className="font-bold text-3xl text-foreground">42</h3>
                ...
                <div className="flex items-end gap-2">
                    <h3 className="font-bold text-3xl text-foreground">8</h3>
                ...
                <div className="flex items-end gap-2">
                    <h3 className="font-bold text-3xl text-foreground">1</h3>
                    <span className="text-xs font-medium text-secondary mb-1">
                    Pending response
                    </span>
                </div>
