            ...
            <div className="w-full mx-auto px-4 sm:px-6 lg:px-6">
                <div className="flex items-center justify-between h-16">
                    ...
                    <nav className="flex items-center gap-3">
                        ...
                        {session ? (
                            <Link href="/dashboard" className="px-4 py-2 rounded-lg text-sm font-semibold bg-primary-hover text-white transition-all">
                                Dashboard
                            </Link>
                        ) : (
                            <Link href="/login" className="px-4 py-2 rounded-lg text-sm font-semibold bg-primary-hover text-white transition-all">
                                Login
                            </Link>
                        )}                        
                    </nav>
